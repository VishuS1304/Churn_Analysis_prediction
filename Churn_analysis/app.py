...
model = joblib.load("G:/VS_Code/Churn_analysis/model.sav")
df_1=pd.read_csv("G:/VS_Code/Churn_analysis/first_telc.csv")
...
def predict(): 
    ...
    model = pickle.load(open("G:/VS_Code/Churn_analysis/model.sav", "rb"))
...
#final_df=pd.concat([new_df__dummies, new_dummy], axis=1)
    ...
    return render_template('"G:/VS_Code/Churn_analysis/template/index.html"', output1=o1, output2=o2, 
